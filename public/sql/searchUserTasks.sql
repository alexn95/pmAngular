CREATE FUNCTION searchUserTasks (@title NVARCHAR(50), @state NVARCHAR(15), @onlyYourTask NVARCHAR(10), @userId INT, @ofset INT, @count INT)
  ...
  SELECT * FROM searchUserTasks('', '', 'true', 1, 0, 10)
